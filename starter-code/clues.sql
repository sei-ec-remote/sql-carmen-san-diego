...
------------------------------------------------------------------------------------------------
SELECT name, code, population FROM countries 
...
SELECT language, countrycode  FROM countrylanguages 
...
SELECT countrycode, name FROM cities 
...
-- She's in ____________ SANTA MONICA ________________!
