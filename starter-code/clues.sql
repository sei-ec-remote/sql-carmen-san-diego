...
SELECT * FROM countrylanguages WHERE countrycode=(SELECT code FROM countries WHERE name LIKE '%Vatican%')
--Italian
...
SELECT name, countrycode FROM cities WHERE name LIKE 'Serra%' AND countrycode<>'SMR'
--Serravalle, BRA
...
-- Clue #6: We're close! Our South American agent says she just got a taxi at the airport, and is headed towards
 ...
 SELECT name, countrycode FROM cities WHERE id=(SELECT capital FROM countries WHERE code='BRA')
 --Brasilia, BRA
