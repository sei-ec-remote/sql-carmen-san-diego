...
world=# SELECT name, region, population, code FROM countries WHERE
population = (SELECT MIN(population) FROM countries WHERE region = 'Southern Europe') AND region = 'Southern Europe';
              name               |     region      | population | code 
---------------------------------+-----------------+------------+------
 Holy See (Vatican Cities State) | Southern Europe |       1000 | VAT
(1 row)
