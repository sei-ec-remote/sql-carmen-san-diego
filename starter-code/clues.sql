...
-- SELECT language FROM countrylanguages WHERE countrycode=(SELECT code FROM countries WHERE population = (SELECT MIN(population) FROM countries WHERE region='Southern Europe'));
...
-- SELECT * FROM cities WHERE countrycode='SMR' AND name NOT LIKE 'San Marino';
...
-- SELECT name FROM cities WHERE id= (SELECT capital FROM countries WHERE code = (SELECT countrycode FROM cities WHERE name='Serra'));
--  Bras�lia
