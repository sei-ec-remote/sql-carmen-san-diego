...
SELECT * FROM countrylanguages, countries
WHERE language = 'Italian'and percentage=100 and countries.code = countrylanguages.countrycode;
--Answer: San Marino
...
WHERE code = (
    ...
    WHERE name <> 'Serravalle' and name LIKE 'Serr%');
--Answer: Brazil
...
SELECT * FROM cities
WHERE id=(SELECT capital FROM countries
WHERE name='Brazil');
--Answer: Brasilia
...
-- She's in ______SANTA MONICA____________!
