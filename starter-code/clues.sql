...
SELECT name FROM cities WHERE country = 'San Marino' AND name <> 'Holy See';
--Serravalle
...
world=# SELECT countrycode FROM cities WHERE name LIKE 'Serra%';
--BRA
...
world=# SELECT capital FROM countries WHERE name = 'Brazil';
